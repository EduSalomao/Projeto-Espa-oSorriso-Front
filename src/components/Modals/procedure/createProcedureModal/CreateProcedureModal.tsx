...
import * as S from "./CreateProcedureModal.style";
...
function CreateProcedureModal({ isOpen, onClose }: Props) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      console.log("Dados do procedimento:", form);
      enqueueSnackbar('Procedimento cadastrado com sucesso!', { 
        variant: 'success', 
        autoHideDuration: 4000, 
        TransitionProps: { direction: 'down' }, 
        anchorOrigin: { vertical: 'top', horizontal: 'center' } 
      ...
      enqueueSnackbar('Não foi possível cadastrar o procedimento.', { 
        variant: 'error', 
        autoHideDuration: 4000, 
        TransitionProps: { direction: 'down' }, 
        anchorOrigin: { vertical: 'top', horizontal: 'center' } 
